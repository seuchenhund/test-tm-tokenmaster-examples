...
import "./PromotionalPoolTokenHandler.sol";
...
contract PromotionalPoolTokenInvariants is TokenMasterTest {
    BondedPool public pool;
    PromotionalPoolTokenHandler public handler;
    ...
    function setUp() public override {
        ...
        handler = new PromotionalPoolTokenHandler(TokenMasterTest(address(this)), tokenMasterRouter, pool, deploymentParameters, initParams);
        ...
        selectors[0] = PromotionalPoolTokenHandler.buyTokens.selector;
        selectors[1] = BondedPoolHandler.addSpendSigner.selector;
        selectors[2] = BondedPoolHandler.spendTokens.selector;
        selectors[3] = PromotionalPoolTokenHandler.setBuyParameters.selector;
