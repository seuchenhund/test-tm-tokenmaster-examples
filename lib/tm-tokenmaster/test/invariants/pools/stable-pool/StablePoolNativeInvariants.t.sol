...
import "./StablePoolNativeHandler.sol";
...
contract StablePoolNativeInvariants is TokenMasterTest {
    BondedPool public pool;
    StablePoolNativeHandler public handler;
    ...
    function setUp() public override {
        ...
        handler = new StablePoolNativeHandler(TokenMasterTest(address(this)), tokenMasterRouter, pool, deploymentParameters, initParams);
        ...
        selectors[0] = StablePoolNativeHandler.buyTokens.selector;
        selectors[1] = StablePoolNativeHandler.sellTokens.selector;
        selectors[2] = BondedPoolHandler.addSpendSigner.selector;
        selectors[3] = BondedPoolHandler.spendTokens.selector;
        selectors[4] = StablePoolNativeHandler.setBuyParameters.selector;
        selectors[5] = StablePoolNativeHandler.setSellParameters.selector;
