...
contract PromotionalPoolTokenForwardedTest is PromotionalPoolTokenTest {
    ...
    function _deployToken(
        ...
        tokenAddress = _executeDeployTokenForwarder(testForwarder, deployer, 0, deploymentParameters, signature, errorSelector);
