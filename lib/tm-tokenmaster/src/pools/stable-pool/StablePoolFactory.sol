...
import "./StablePoolCreationCode.sol";
 ...
 * @notice Factory contract for deploying StablePool contracts from TokenMasterRouter.
 * 
 ...
 */
contract StablePoolFactory is ITokenMasterFactory {
    ...
    constructor(address tokenMasterRouter) {
        ...
        CREATION_CODE = address(new StablePoolCreationCode());
    }
    /**
     * @notice Deploys a new StablePool token with the provided parameters and returns the deployment address.
     * 
     * @param tokenSalt             The salt value for the contract creation.
     * @param poolParams            The parameters for the StablePool pool.
    ...
    /**
     * @notice Calculates the deployment address of a StablePool based on the deployment parameters.
     * 
     * @param tokenSalt             The salt value for the contract creation.
     * @param poolParams            The parameters for the StablePool pool.
     * @param pairedValueIn         The amount of paired value sent with the deployment transaction.
